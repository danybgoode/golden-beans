 ...
 */
// `reference-experiments.css` joined 2026-09-24 (experiments-for-humans D12): the second approved
// prototype's additions, verbatim, generated by the same script under the same `--check`.
export const GENERATED_STYLESHEETS = ['tokens.css', 'reference.css', 'reference-experiments.css'];
