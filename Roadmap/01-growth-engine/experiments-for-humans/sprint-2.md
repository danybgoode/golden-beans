...
**Status:** ✅ shipped 2026-09-25 — danybgoode/golden-beans#169, squash `bf62913`; 8 review rounds (last two clean from both layers); amendment A7 recorded for Daniel · **Wave 1** · branch `feat/experiments-for-humans-s2` (stacked on S1)
