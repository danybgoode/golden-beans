...
test('canonicalizes the PostgREST UTC-offset form for strict wire contracts', () => {
  assert.equal(canonicalizeDatabaseInstant('2026-07-30T01:06:19.934305+00:00'), '2026-07-30T01:06:19.934Z')
})

test('normalizes non-UTC offsets to canonical UTC', () => {
  assert.equal(canonicalizeDatabaseInstant('2026-07-30T06:06:19.934+05:00'), '2026-07-30T01:06:19.934Z')
})
