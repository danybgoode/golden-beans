  ...
  return (
    <main>
      ...
      <p>
        ...
        lens. It is a bearer token: anyone holding the URL can read it, so treat it like a password
        and revoke it when the conversation ends. Revocation takes effect on the next request, no
        deploy needed.
      </p>
      <p>
